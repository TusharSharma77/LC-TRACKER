...
export default function App() {
  ...
  const [tab, setTab] = useState("topics"); // "problems" | "stats" | "topics"
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0d1117", fontFamily: "'DM Mono', 'Courier New', monospace", color: "#e6edf3" }}>
      <style>{`
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "28px 14px 60px" }}>
        ...
        <div style={{ marginBottom: 28 }}>
          <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 14, flexWrap: "wrap", marginBottom: 6 }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: 14, flexWrap: "wrap" }}>
              <h1 style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: "clamp(22px,5vw,34px)", background: "linear-gradient(90deg, #60a5fa, #c084fc, #f472b6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "-0.5px", lineHeight: 1 }}>
                Tushar Sharma Sheet
              </h1>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4 }}>
              <div style={{ fontSize: 10, color: "#8fa8bf", fontFamily: "'Inter', sans-serif", fontWeight: 600 }}>Question Contributors:</div>
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                <a href="https://www.linkedin.com/in/kunal-pal-0ab401321/" target="_blank" rel="noopener noreferrer" style={{ color: "#60a5fa", textDecoration: "none", fontSize: 11, fontFamily: "'Inter', sans-serif", fontWeight: 500, display: "flex", alignItems: "center", gap: 3 }}>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                  </svg>
                  Kunal Pal
                </a>
                <a href="https://www.linkedin.com/in/lucky-yadav-9a3706331/" target="_blank" rel="noopener noreferrer" style={{ color: "#60a5fa", textDecoration: "none", fontSize: 11, fontFamily: "'Inter', sans-serif", fontWeight: 500, display: "flex", alignItems: "center", gap: 3 }}>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                  </svg>
                  Lucky Yadav
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
          ...
          <button className={`tab-btn${tab === "problems" ? " active" : ""}`} onClick={() => setTab("problems")}>LIST</button>
        ...
        {tab === "topics" && (
          <div className="anim">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(140px, 1fr))", gap: 10, marginBottom: 24, paddingBottom: 20, borderBottom: "1px solid #1c2130" }}>
              {topicStats.map(({ topic, total: t, done }) => {
                ...
                return (
                  ...
                  >
                    <span style={{ color: ts.text, fontSize: 13, fontWeight: "bold" }}>{topic}</span>
                    <span style={{ fontSize: 11, color: "#8fa8bf" }}>{done}/{t} done</span>
                  </button>
                )
              })}
            </div>
            ...
            {randomProblem && (
              <div style={{ background: "#1a2030", border: "1px solid #3a4a60", borderRadius: 8, padding: 16, marginBottom: 24 }}>
